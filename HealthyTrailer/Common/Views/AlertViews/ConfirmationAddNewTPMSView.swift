//
//  ConfirmationAddNewTPMSView.swift
//  HealthyTrailer
//
...
struct ConfirmationAddNewTPMSAlertView: ViewModifier {
    ...
    private var alert: some View {
        if showAlert {
            ConfirmationAddNewTPMSView(showAlert: $showAlert, onButtonTap: onButtonTap)
...
struct ConfirmationAddNewTPMSView: View {
...
#Preview {
    ConfirmationAddNewTPMSView(showAlert: .constant(true), onButtonTap: {})
}
